...
public:
  ...
  // set lbound/rbound
  void set_lbound(oa_int3 lb);
  void set_rbound(oa_int3 rb);

  // set lbound/rbound when has two children
  void set_lbound(oa_int3 left_lb, oa_int3 right_lb);
  void set_rbound(oa_int3 left_rb, oa_int3 ribht_rb);
