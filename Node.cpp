...
oa_int3 Node::get_lbound() {
  return m_lbound;
}

oa_int3 Node::get_rbound() {
  return m_rbound;
}

void Node::set_lbound(oa_int3 lb) {
  m_lbound = lb;
}

void Node::set_rbound(oa_int3 rb) {
  m_rbound = rb;
}

void Node::set_lbound(oa_int3 b1, oa_int3 b2) {
  m_lbound[0] = max(b1[0], b2[0]);
  m_lbound[1] = max(b1[1], b2[1]);
  m_lbound[2] = max(b1[2], b2[2]);
}

void Node::set_rbound(oa_int3 b1, oa_int3 b2) {
