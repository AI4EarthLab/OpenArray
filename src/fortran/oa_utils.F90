...
contains
  ...
  subroutine g_flag(key)
    use iso_c_binding
    implicit none
    integer :: key

    interface
       subroutine c_g_flag(key) &
            bind(C, name="c_g_flag")
         use iso_c_binding
         implicit none
         integer :: key
       end subroutine
