...
namespace oa{
  namespace internal{
    ...
    template<typename T>
    void buffer_sum_y_const(T *ap, T *A, Box box, int sw, int size, T *buffer, int type) {
      int xs, xe, ys, ye, zs, ze;
      box.get_corners(xs, xe, ys, ye, zs, ze, sw);
    ...
    template<typename T>
    void buffer_sum_z_const(T *ap, T *A, Box box, int sw, int size, T *buffer, int type) {
      int xs, xe, ys, ye, zs, ze;
      box.get_corners(xs, xe, ys, ye, zs, ze, sw);
