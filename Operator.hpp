...
namespace oa {
  namespace ops {
    ...
    void tree_to_code_with_op(NodePtr A, stringstream &ss, stringstream &__point, 
			stringstream &__point_in, stringstream &__point_out, int &id, int &S_id,
    ...
    void code_add_const(stringstream& __code__const, vector<int>& i, vector<int>& f, vector<int>& d);
    ...
    void code_add_calc_inside(stringstream& code, stringstream& __code__const, 
      stringstream& __code, stringstream& __point, stringstream& __point_in, 
 			stringstream& __point_out, vector<int>& int_id, vector<int>& float_id, vector<int>& double_id, 
